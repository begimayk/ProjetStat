...
### Hauteur d'attaque des joueueses
...
* H0 : La variable suit pas la loi normale 
* H1 : La variable ne suit la loi normale
```{r}
...
Après avoir étudié les pays de naissance des joueuses, nous pouvons désormais analyser d'autres données spécifiques en les associant à leur pays d'origine.
...
Sur ce diagramme en boîte à moustaches, nous pouvons observer les quartiles et la moyenne de la hauteur d'attaque des joueuses en fonction de leur pays de naissance. Les quartiles représentent la répartition des valeurs de la hauteur d'attaque, tandis que la ligne centrale dans la boîte indique la médiane.
