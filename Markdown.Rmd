...
p <- ggplot(moyenne_attaque, aes(x = Pays, y = Moyenne_attaque, fill = Pays)) +
  ...
  labs(title = "Moyenne d'attaque par pays", col= c("#F2B5D4", "#B8E3E6", "#FFDB9A", "#B3D9B2", "#FAC8A7", "#D7D7E0",
                "#F9E6B8", "#B7C9E2", "#F1C2DC", "#C9E8C9", "#FFE4C4", "#D0E0EB"), x = "Pays", y = "Moyenne d'attaque") +
  theme_minimal() +
...
Sur ce graphique, nous pouvons observer que la distribution de la variable de block s'approche de la loi normale (par une courbe gaussienne).
...
Nous pouvons estimer que la taille moyenne se situe dans l'intervalle [179.6347, 182.3653] avec un niveau de confiance de 95%.
La taille moyenne d'une joueuse est de 181 cm.
...
Après avoir étudié séparément le poste des joueuses et leur hauteur de bloc, nous pouvons désormais analyser la hauteur de bloc selon le poste des joueuses.
