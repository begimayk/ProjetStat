...
Nous retrouvons dans ce fichier l'id de la joueuse, son nom et prénom, sa date de naissance, sa taille (en cm), son poids (en kg), sa hauteur maximale à l'attaque (en cm), sa hauteur maximale au bloc (en cm), sa position sur le terrain (autrement dit son poste) ainsi que le code de son pays de naissance.
Nous avons décidé de garder pour notre étude le nom, l'année de naissance uniquement, la taille, le poids, la hauteur d'attaque, la hauteur de bloc, le poste (nous avons décidé de changer la position sur le terrain par l'appellation du poste directement pour des questions de pratique) et le pays de naissance sur lequel nous avons aussi étudié chaque code de pays afin de changer le code du pays par son nom directement pour des questions de pratique, de compréhension et de meilleure interprétation également.
