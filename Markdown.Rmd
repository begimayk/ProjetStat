...
* H0 : La variable ne suit pas la loi normale 
* H1 : La variable suit la loi normale
```{r}
...
* Test d'égalité des moyennes de la hauteur d'attaque entre la Cuba et la Cuba et l'Égypte. Les hypothèses sont les suivantes 
...
t.test(attaque_cuba, attaque_egypt)
```
La p-valeur est plus petite que dans le premier test mais elle reste supérieure au risque de 5%. Nous n'avons donc pas suffisament de preuve pour rejetter l'hypothèse nulle HO selon laquelle les deux moyennes sont égales par consequent nous l'acceptons. Nous observons que la différence entre ces deux moyennes se trouve dans l'intervalle [-1.4, 50.1] avec un niveau de confiance de 95%.

Vu que nous supposons que les moyennes sont égales 


//// Pour analyse qualixquali
